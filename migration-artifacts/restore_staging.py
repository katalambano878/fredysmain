#!/usr/bin/env python3
"""Restore Jane's Luxe dump into frebys_staging (or janesluxe) on fleet-postgres."""
import json
import os
import subprocess
import sys
...
DUMP = Path(os.environ.get("FB_DUMP_DIR", "/data/coolify/frebys-staging/dumps"))
DB = os.environ.get("FB_DB_NAME", "frebys_staging")
ROLE = os.environ.get("FB_DB_ROLE", DB)
...
JSONB_COLS = {
    ...
    "product_cost_of_production": {"per_variant_costs"},
